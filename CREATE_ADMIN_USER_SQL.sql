...
-- This will create the user but metadata must be set via dashboard
...
BEGIN
    ...
    INSERT INTO auth.users (
        ...
        crypt('DCode@2024!', gen_salt('bf')), -- Replace with your desired password
...
-- UPDATE auth.users
-- SET user_metadata = '{"is_admin": true}'::jsonb,
--     updated_at = NOW()
